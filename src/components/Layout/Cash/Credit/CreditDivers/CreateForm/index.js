...
const CreateForm = (props) => {
  ...
  const [form,setForm] = React.useState({
    type:'divers',taux:sessionStorage.taux,currency:null,tauxEuro:null,nbr_echeance:null,
    amount: 0, provider: null, agent: null, motif: "", creditEcheances: [],
  })

  const onReset = () => {
    setForm({
      typeCredit: 'divers', taux: null, currency: null, tauxEuro: null, nbr_echeance: null, amount: 0, 
