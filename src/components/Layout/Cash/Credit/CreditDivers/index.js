...
const CreditDivers = (props) => {
  ...
  return (
    <Row>
      ...
      <Col span={24}>
        <ReadEntities entityName="provider" params={{credit:"divers"}}>
          {
            rest => (
              <TableComponent { ...rest } />
            )
      ...
      <Modal title="Crédit Fournisseur" visible={visible} centered
